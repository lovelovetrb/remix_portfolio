...
var works = [
  {
    prize: "\u6280\u80B2\u5C552023\u6C7A\u52DD\u5927\u4F1A\u9032\u51FA",
    title: "ES Harmony",
    description: "\u30A8\u30F3\u30B8\u30CB\u30A2\u3092\u63A1\u7528\u3059\u308B\u4F01\u696D\u306B\u5411\u3051\u305F\u63A1\u7528\u652F\u63F4\u30C4\u30FC\u30EB\u300CES Harmony\u300D\u3067\u3059\u3002\u81EA\u7136\u8A00\u8A9E\u51E6\u7406\u3092\u7528\u3044\u305FAI\u3067\u63A1\u7528\u30D7\u30ED\u30BB\u30B9\u3092\u5927\u5E45\u306B\u7C21\u7565\u5316\u3057\u307E\u3059\u3002\u5B8C\u5168\u306BAI\u306B\u4EFB\u305B\u305A\u3001\u3042\u304F\u307E\u3067\u300C\u63A1\u7528\u3092\u30B5\u30DD\u30FC\u30C8\u3059\u308B\u300D\u30C4\u30FC\u30EB\u3092\u76EE\u6307\u3057\u307E\u3057\u305F\u3002",
    image: [
      { src: "/works/es_harmony_top.png", alt: "ES Harmony" },
  ...
  },
  {
    ...
    description: "\u30B5\u30DD\u30FC\u30BF\u30FC\u30BA\u793E\u304C\u4E3B\u50AC\u3059\u308B\u6280\u80B2CAMP\u30CF\u30C3\u30AB\u30BD\u30F3 vol.11(2023/02/11~12)\u306B\u3066\u958B\u767A\u3057\u305F\u4F5C\u54C1\u3067\u3059\u3002\u30B3\u30ED\u30CA\u798D\u306B\u304A\u3051\u308B\u30DE\u30B9\u30AF\u306E\u7740\u8131\u306E\u30DE\u30B8\u30E7\u30EA\u30C6\u30A3\u3092AI\u306B\u3088\u3063\u3066\u53EF\u8996\u5316\u3059\u308B\u30A2\u30D7\u30EA\u306B\u306A\u308A\u307E\u3059\u3002",
    image: [{ src: "/works/majority_railway.png", alt: "majority railway" }],
    twitter: "https://twitter.com/geek_pjt/status/1624701536705318912"
  },
  {
    title: "\u30A8\u30E2\u3061\u3083\u308C",
    description: "\u30B5\u30DD\u30FC\u30BF\u30FC\u30BA\u793E\u304C\u4E3B\u50AC\u3059\u308B\u6280\u80B2CAMP\u30CF\u30C3\u30AB\u30BD\u30F3\u958B\u767A\u3057\u305F\u4F5C\u54C1\u3067\u3059\u3002\u30D7\u30EC\u30A4\u30E4\u30FC\u304C\u611F\u60C5\u3092\u6307\u5B9A\u3055\u308C\u305F\u5358\u8A9E\u3092\u7528\u3044\u3066\u8868\u73FE\u3057\u3001\u305D\u306E\u6587\u7AE0\u3092\u5927\u898F\u6A21\u8A00\u8A9E\u30E2\u30C7\u30EBBERT\u3092\u611F\u60C5\u5206\u985E\u30BF\u30B9\u30AF\u306B\u30D5\u30A1\u30A4\u30F3\u30C1\u30E5\u30FC\u30CB\u30F3\u30B0\u3057\u305F\u8A00\u8A9E\u30E2\u30C7\u30EB\u306B\u3088\u3063\u3066\u7B97\u51FA\u3055\u308C\u305F\u30B9\u30B3\u30A2\u3092\u7AF6\u3046\u30B2\u30FC\u30E0\u3092\u958B\u767A\u3057\u307E\u3057\u305F\u3002",
    image: [{ src: "/works/emochare.png", alt: "\u30A8\u30E2\u3061\u3083\u308C" }]
  }
];
...
var Tween = (
  ...
  function() {
    ...
    Tween2.prototype.to = function(properties2, duration) {
      this._valuesEnd = Object.create(properties2);
      if (duration !== void 0) {
...
var showPreviousArrow = function showPreviousArrow2(_ref, currentIndex, moveSlides) {
  ...
  if (prevArrow) {
    return /* @__PURE__ */ import_react.default.cloneElement(prevArrow, _extends({
      className: (prevArrow.props.className || "") + " nav " + (isDisabled ? "disabled" : "")
    }, props));
  }
  var className = "nav default-nav " + (isDisabled ? "disabled" : "");
  return /* @__PURE__ */ import_react.default.createElement("button", Object.assign({
    type: "button",
    className
  }, props), /* @__PURE__ */ import_react.default.createElement("svg", {
    width: "24",
    height: "24",
    viewBox: "0 0 24 24"
...
var showNextArrow = function showNextArrow2(properties2, currentIndex, moveSlides) {
  var nextArrow = properties2.nextArrow, infinite = properties2.infinite, children = properties2.children;
  var slidesToScroll = 1;
  if ("slidesToScroll" in properties2) {
    slidesToScroll = properties2.slidesToScroll || 1;
  }
  ...
  if (nextArrow) {
    return /* @__PURE__ */ import_react.default.cloneElement(nextArrow, _extends({
...
var showDefaultIndicator = function showDefaultIndicator2(isCurrentPageActive, key, indicatorProps) {
  return /* @__PURE__ */ import_react.default.createElement("li", {
    key
  }, /* @__PURE__ */ import_react.default.createElement("button", Object.assign({
    type: "button",
...
var showCustomIndicator = function showCustomIndicator2(isCurrentPageActive, key, indicatorProps, eachIndicator) {
  return /* @__PURE__ */ import_react.default.cloneElement(eachIndicator, _extends({
...
var FadeZoom = /* @__PURE__ */ import_react.default.forwardRef(function(props, ref) {
  ...
  }, props.arrows && showPreviousArrow(props, index2, preTransition), /* @__PURE__ */ import_react.default.createElement("div", {
...
var Fade = /* @__PURE__ */ import_react.default.forwardRef(function(props, ref) {
  return /* @__PURE__ */ import_react.default.createElement(FadeZoom, Object.assign({}, props, {
    scale: 1,
    ref
  }));
});
Fade.defaultProps = defaultProps;
var Zoom = /* @__PURE__ */ import_react.default.forwardRef(function(props, ref) {
  return /* @__PURE__ */ import_react.default.createElement(FadeZoom, Object.assign({}, props, {
    ref
  }));
});
Zoom.defaultProps = defaultProps;
var Slide = /* @__PURE__ */ import_react.default.forwardRef(function(props, ref) {
  var _useState = (0, import_react.useState)(getStartingIndex(props.children, props.defaultIndex)), index2 = _useState[0], setIndex = _useState[1];
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", {
    ...
    onTouchMove: swipe
  }, props.arrows && showPreviousArrow(props, index2, moveSlides), /* @__PURE__ */ import_react.default.createElement("div", {
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/Slider.tsx"' + id);
  };
...
var properties = {
  prevArrow: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { className: "mx-1 md:mx-3 md:text-2xl text-gray-700 text-opacity-50", children: "\u25C0\uFE0E" }, void 0, false, {
    fileName: "app/components/Slider.tsx",
    lineNumber: 30,
    columnNumber: 14
  }, this),
  nextArrow: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { className: "mx-1 md:mx-3 md:text-2xl text-gray-700 text-opacity-50", children: "\u25B6\uFE0E" }, void 0, false, {
    fileName: "app/components/Slider.tsx",
    lineNumber: 33,
    columnNumber: 14
  }, this)
...
var Slideshow = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: images.length > 1 ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Slide, { ...properties, children: images.map((slideImage, index2) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: slideImage.src, alt: slideImage.alt }, void 0, false, {
    fileName: "app/components/Slider.tsx",
    lineNumber: 43,
    columnNumber: 15
  }, this) }, index2, false, {
    ...
    lineNumber: 41,
    columnNumber: 28
  }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: images[0].src, alt: images[0].alt }, void 0, false, {
    fileName: "app/components/Slider.tsx",
    lineNumber: 45,
    columnNumber: 20
  }, this) }, void 0, false, {
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/WorkCard.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
var WorkCard = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "bg-white bg-opacity-20 rounded-lg mx-auto my-5 p-5 w-11/12 relative", children: [
    work.prize && /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { style: prizeStyle, className: "absolute text-sm md:text-md text-xl", children: work.prize }, void 0, false, {
      fileName: "app/components/WorkCard.tsx",
      lineNumber: 38,
      columnNumber: 22
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: `${work.prize && "mt-10"}`, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Slider_default, { images: work.image }, void 0, false, {
      fileName: "app/components/WorkCard.tsx",
      lineNumber: 42,
      columnNumber: 9
    }, this) }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("h2", { className: "my-3 lg:text-2xl text-2xl font-semibold", children: work.title }, void 0, false, {
      fileName: "app/components/WorkCard.tsx",
      lineNumber: 44,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "my-3 lg:text-xl", children: work.description }, void 0, false, {
      fileName: "app/components/WorkCard.tsx",
      lineNumber: 45,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex justify-around mt-5", children: [
      work.demo && /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("a", { href: work.demo, target: "_blank", rel: "noopener noreferrer", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "text-xl", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(FontAwesomeIcon, { icon: faHome }, void 0, false, {
        fileName: "app/components/WorkCard.tsx",
        lineNumber: 49,
        columnNumber: 15
      }, this) }, void 0, false, {
      ...
      work.github && /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("a", { href: work.github, target: "_blank", rel: "noopener noreferrer", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "text-xl", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(FontAwesomeIcon, { icon: faGithub }, void 0, false, {
        fileName: "app/components/WorkCard.tsx",
        lineNumber: 54,
        columnNumber: 15
      }, this) }, void 0, false, {
      ...
      work.twitter && /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("a", { href: work.twitter, target: "_blank", rel: "noopener noreferrer", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "text-xl", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(FontAwesomeIcon, { icon: faTwitter }, void 0, false, {
        fileName: "app/components/WorkCard.tsx",
        lineNumber: 59,
        columnNumber: 15
      }, this) }, void 0, false, {
...
_c2 = WorkCard;
var WorkCard_default = WorkCard;
var _c2;
$RefreshReg$(_c2, "WorkCard");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
...
function Index() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_jsx_dev_runtime3.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Background_default, { styleName: "none", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("h2", { className: "lg:text-5xl md:text-3xl text-2xl m-5", children: "Works..." }, void 0, false, {
      fileName: "app/routes/works.tsx",
      lineNumber: 35,
      columnNumber: 9
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "flex flex-col", children: works.map((work) => /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(WorkCard_default, { work }, work.title, false, {
      fileName: "app/routes/works.tsx",
      lineNumber: 37,
      columnNumber: 30
    }, this)) }, void 0, false, {
...
//# sourceMappingURL=/build/routes/works-7TUSTJY5.js.map
