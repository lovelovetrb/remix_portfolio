export const papers = [
  ...
  },
  {
    ...
    image: [
      {
        src: "/papers/Function_Analysis_of_Attention_Heads.jpeg",
        alt: "日本語事前学習済みBERTの言語学的機能による差分入力を用いたAttentionヘッド別機能分析",
      },
    ],
    news: "https://www.jstage.jst.go.jp/article/pjsai/JSAI2024/0/JSAI2024_3Xin269/_article/-char/ja",
  },

  {
    title: "大規模LSTMを用いた言語モデルの開発と日本語における効果検証",
    description:
    ...
    image: [
      {
        src: "/papers/Development_of_a_Large-Scale_LSTM_Language_Model_and_Effectiveness_Verification_in_Japanese.png",
        alt: "大規模LSTMを用いた言語モデルの開発と日本語における効果検証",
      },
    ],
    news: "https://drive.google.com/file/d/1b6qeXSamvqNUoz9f7UeurwVmgGn3snWo/view?usp=drive_link",
  },
];
